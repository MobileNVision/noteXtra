...
import com.mobilenvision.notextra.data.local.db.dao.DailyDao
...
@Database(entities = [User::class, Note::class, Category::class, Daily::class], version = 1, exportSchema = false)
